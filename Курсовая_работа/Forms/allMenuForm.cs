...
{
    public partial class allMenuForm : Form
    {
        ...
        public allMenuForm()
        {
            ...
            profile_button.MouseEnter += ButtonInteraction.UpScale_button;
            profile_button.MouseLeave += ButtonInteraction.DownScale_button;
        }
