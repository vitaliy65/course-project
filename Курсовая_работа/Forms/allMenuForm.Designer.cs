namespace Курсовая_работа.Forms
{
    partial class allMenuForm
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(allMenuForm));
            panel1 = new Panel();
            ...
            panel1.Controls.Add(profile_button);
            ...
            profile_button.BackgroundImage = (Image)resources.GetObject("profile_button.BackgroundImage");
            ...
            profile_button.FlatAppearance.MouseDownBackColor = Color.Transparent;
            profile_button.FlatAppearance.MouseOverBackColor = Color.Transparent;
            profile_button.FlatStyle = FlatStyle.Flat;
            profile_button.Location = new Point(964, 10);
            profile_button.Name = "profile_button";
            profile_button.Size = new Size(48, 48);
            profile_button.TabIndex = 40;
            profile_button.UseVisualStyleBackColor = false;
            profile_button.MouseClick += profile_button_MouseClick;
            // 
            // panel2
            // 
